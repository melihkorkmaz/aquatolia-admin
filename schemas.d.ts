...
export interface ApiNavigationNavigation extends CollectionTypeSchema {
  info: {
...
export interface ApiProductProduct extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    mainImage: MediaAttribute;
    images: MediaAttribute;
    price: DecimalAttribute;
    discountedPrice: DecimalAttribute;
    order: IntegerAttribute;
    ...
    SKU: StringAttribute;
    EAN: StringAttribute;
    productProperties: RelationAttribute<
      'api::product.product',
      'oneToMany',
      'api::product-property.product-property'
    >;
    variants: RelationAttribute<
      'api::product.product',
      'manyToMany',
...
export interface ApiProductPropertyProductProperty
  ...
  attributes: {
    propertyType: RelationAttribute<
      'api::product-property.product-property',
      'oneToOne',
      'api::product-property-type.product-property-type'
    >;
...
export interface ApiProductPropertyTypeProductPropertyType
  extends CollectionTypeSchema {
  info: {
    singularName: 'product-property-type';
    pluralName: 'product-property-types';
    displayName: 'ProductPropertyType';
    description: '';
  };
  options: {
    draftAndPublish: false;
...
export interface ApiProductVariantProductVariant extends CollectionTypeSchema {
  info: {
...
declare global {
  namespace Strapi {
    interface Schemas {
      ...
      'api::product-property-type.product-property-type': ApiProductPropertyTypeProductPropertyType;
